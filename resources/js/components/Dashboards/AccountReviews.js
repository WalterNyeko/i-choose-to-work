                ...
                <div class="row">
                            ...
                            <div class="content">
                                <ul class="dashboard-box-list">
                                    ...
                                    <li>
                                        ...
                                        >
                                            <i class="icon-feather-edit" /> Edit
                                            Review
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <nav class="pagination">
                                <ul>
                                    <li>
                                        <a
                                            href="#"
                                            class="ripple-effect current-page"
                                        >
                                            1
                                        </a>
                                    </li>
                    ...
                    <div class="col-xl-6">
                        <div class="dashboard-box margin-top-0">
                            ...
                            <div class="headline">
                                <h3>
                                    <i class="icon-material-outline-face" />{" "}
                                    Rate Freelancers
                                </h3>
                            </div>
