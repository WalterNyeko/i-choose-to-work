                    ...
                    <ul class="dashboard-box-list">
                      <li>
                        ...
                        <a
                          ...
                          ><i class="icon-material-outline-thumb-up"></i> Leave
                          a Review</a
                        >
                      </li>
                      <li>
              ...
              <div class="col-xl-6">
                <div class="dashboard-box margin-top-0">
                 {/**  <!-- Headline -->*/}
                  <div class="headline">
                    <h3>
                      <i class="icon-material-outline-face"></i> Rate
                      Freelancers
                    </h3>
                  </div>
        ...
        <div class="popup-tabs-container">
          ...
          <div class="popup-tab-content" id="tab1">
            ...
            <div class="welcome-text">
              <h3>Change Review</h3>
              <span
                >Rate <a href="#">Herman Ewout</a> for the project
                <a href="#">WordPress Theme Installation</a>
              </span>
            </div>
            ...
            <form method="post" id="change-review-form">
              <div class="feedback-yes-no">
                ...
                <div class="radio">
                  ...
                  <label for="radio-rating-1"
                    ><span class="radio-label"></span> Yes</label
                  >
                </div>
                ...
                <div class="radio">
                  ...
                  <label for="radio-rating-2"
                    ><span class="radio-label"></span> No</label
                  >
                </div>
              </div>
              ...
              <textarea
                ...
                required
              >
Excellent programmer - helped me fixing small issue.</textarea
              >
            </form>
        ...
        <div class="popup-tabs-container">
          ...
          <div class="popup-tab-content" id="tab2">
            ...
            <div class="welcome-text">
              ...
              <span
                >Rate <a href="#">Peter Valentín</a> for the project
